...
static Key keys[] = {
	...
	{ MODKEY,							  111,	   spawn,	   { .v = volup } },
	{ MODKEY,							  116,   spawn,	   { .v = voldown }},
	{ MODKEY|ShiftMask,							  219,	   spawn,	   { .v = screenshot }},
	{ MODKEY,                       76,	   spawn,          { .v = setkbengram } },
	{ MODKEY,                       95,    spawn,          { .v = setkbqwerty } },
    { MODKEY,                       71,     spawn,          { .v = brightdown } },
    { MODKEY,                       232,    spawn,          { .v = brightdown } },
    { MODKEY,                       72,     spawn,          { .v = brightup } },
    { MODKEY,                       233,    spawn,          { .v = brightup } },
    { MODKEY,                       67,     spawn,          { .v = brightdef } },
